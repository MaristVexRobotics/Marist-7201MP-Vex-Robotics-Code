...
#pragma config(Motor,  port3,           leftScissor1,  tmotorVex393, openLoop)
#pragma config(Motor,  port4,           leftScissor2,  tmotorVex393, openLoop)
#pragma config(Motor,  port5,           frontClaw,           tmotorVex393, openLoop)
#pragma config(Motor,  port6,           arm2,          tmotorVex393, openLoop)
#pragma config(Motor,  port7,           rightScissor,  tmotorVex393, openLoop, reversed)

...
#pragma config(Motor,  port7,           rightScissor1, tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_6, 1000)
#pragma config(Motor,  port8,           frontClaw,     tmotorVex393, openLoop)
#pragma config(Motor,  port9,           leftScissor1,  tmotorVex393, openLoop, encoder, encoderPort, I2C_5, 1000)
#pragma config(Motor,  port10,          leftScissor2,  tmotorVex393, openLoop)
...
task main() {
	...
	resetEncoders(); // reset all encoders
	//Autonomous();
	while (true) {
		RC();  // recieve inputs
		calcMotorValues();

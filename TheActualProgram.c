...
#pragma config(Motor,  port3,           leftScissor1,  tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_5, 1000)
...
#pragma config(Motor,  port7,           rightScissor1, tmotorVex393, openLoop, encoder, encoderPort, I2C_6, 1000)
